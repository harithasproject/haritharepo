<%@ Control Language="C#" AutoEventWireup="true" CodeFile="direct_admission.ascx.cs" Inherits="office_stud_admission" %>
<body>
        ...
        <asp:Button ID="Button2" runat="server" Text="OK" 
                class="btn btn--radius-2 btn--red" onclick="Button1_Click1" />
                 ...
                 <asp:View ID="View2" runat="server">
                  <asp:Panel ID="Panel3" runat="server"  class="input--style-5" BackColor="#CC66FF">
...
<div class="col-2">
        <div class="input-group-desc">
       <center><font size="4px">Guardian ID</font></center> 
 <asp:TextBox ID="TextBox14" runat="server" class="input--style-5" ReadOnly="true"></asp:TextBox>
            </div></div>
