<%@ Control Language="C#" AutoEventWireup="true" CodeFile="view_gallery.ascx.cs" Inherits="teacher_view_gallery" %>
<asp:DataList ID="DataList1" runat="server" RepeatColumns="3" RepeatDirection="Horizontal" BackColor="Gray" BorderColor="#666666"
