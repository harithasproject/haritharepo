<%@ Control Language="C#" AutoEventWireup="true" CodeFile="remove_feepattern.ascx.cs" Inherits="admin_remove_feepattern" %>
<body>
                            ...
                            <asp:TextBox ID="TextBox2" runat="server" class="input--style-5"></asp:TextBox>                 
                                     ...
                                     <div class="col-2">
                                        ...
                                        <center><font size="4px">Amount</font></center> 
                                               <asp:TextBox ID="TextBox3" runat="server" class="input--style-5" >
                                                   </asp:TextBox> 
